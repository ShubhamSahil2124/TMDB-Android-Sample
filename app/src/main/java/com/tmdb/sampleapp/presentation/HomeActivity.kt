...
import com.tmdb.sampleapp.databinding.ActivityHomeBinding
import com.tmdb.sampleapp.presentation.adapter.ViewPagerAdapter
import com.tmdb.sampleapp.presentation.adapter.ViewPagerAdapter.Companion.ALL_MOVIES_POSITION
import com.tmdb.sampleapp.presentation.adapter.ViewPagerAdapter.Companion.FAVORITE_MOVIES_POSITION
import com.tmdb.sampleapp.presentation.moviesearch.SearchMoviesFragment
...
class HomeActivity : AppCompatActivity(R.layout.activity_home) {
    ...
    private fun getTabTitle(position: Int): String{
        return when (position){
            ALL_MOVIES_POSITION -> "Movie"
            FAVORITE_MOVIES_POSITION -> "Saved in DB"
            else -> ""
        }
    }
